...
copy /B mado-debug.js+src\adoodbcconnection.js mado-debug.js
...
copy /B mado-debug.js+src\excelcolorconstants.js mado-debug.js
...
copy /B mado-debug.js+src\stream.js mado-debug.js
